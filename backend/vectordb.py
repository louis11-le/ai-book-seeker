...
This module centralizes all vector database operations including:
- ChromaDB initialization and connection
- Embedding creation and storage
- Vector similarity search

By centralizing these functions, we avoid code duplication between modules.
"""
...
# ChromaDB client and configuration
...
def initialize_vector_db(db: Session) -> None:
    ...
    for book in books:
        ...
        content_to_embed = f"Title: {book.title} | Description: {book.description} | Age range: {book.age_range} | Purpose: {book.purpose} | Genre: {book.genre or 'N/A'} | Tags: {book.tags}"
