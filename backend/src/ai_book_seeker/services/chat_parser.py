...
from ai_book_seeker.core.config import OPENAI_API_KEY, OPENAI_MAX_TOKENS, OPENAI_MODEL, OPENAI_TEMPERATURE
...
from ai_book_seeker.services.tools import available_tools
...
def _process_book_search(arguments_json: str) -> Tuple[str, Optional[List[Dict[str, Any]]]]:
    ...
    try:
        ...
        logger.error(f"Error processing book search: {e}")
        assistant_response = "I'm sorry, I encountered an error while searching for books. Please try again."
